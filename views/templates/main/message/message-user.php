...
<div class="user-profile-sidebar">
    <div class="p-3 border-bottom">
        <div class="user-profile-img">
            <img src="/images/avatar-2.jpg" class="profile-img rounded" alt="">
                ...
                <div class="user-chat-nav p-2">
                    <div class="d-flex w-100">
                        ...
                        <div class="flex-shrink-0">
                            <div class="dropdown">
                                <button type="button" class="btn nav-btn text-white dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="p-4 user-profile-desc" data-simplebar>
        ...
        <div class="pb-2">
            ...
            <div>
                ...
                <h5 class="font-size-14 text-truncate"><?= "{$friendName} {$friendSecondName} {$friendLastName}" ?></h5>
            </div>
        ...
        <div>
            ...
            <div class="profile-media-img">
                <div class="media-img-list">
                    <a href="#">
                        <img src="/images/img-1.jpg" class="img-fluid" alt="media img">
                    </a>
                </div>

                <div class="media-img-list">
                    <a href="#">
                        <img src="/images/img-2.jpg" class="img-fluid" alt="media img">
                    </a>
                </div>

                <div class="media-img-list">
                    <a href="#">
                        <img src="/images/img-3.jpg" class="img-fluid" alt="media img">
                    </a>
                </div>

                <div class="media-img-list">
                    <a href="#">
                        <img src="/images/img-4.jpg" class="img-fluid" alt="media img">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0 ms-3">
                            <div class="d-flex gap-2">
                                ...
                                <div class="dropdown">
                                    <a href="#" class="dropdown-toggle text-muted px-1" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="bx bx-dots-horizontal-rounded"></i>
                                    </a>

                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="#" class="dropdown-item d-flex align-items-center justify-content-between">
                                            Share <i class="bx bx-share-alt ms-2 text-muted"></i>
                                        </a>
