    ...
    this.functions = {
        ...
        openEmojiSelector(e) {
            ...
            if (el) {
                ...
                // 40 - ширина самой кнопки, чтобы блок висел над ней, а не сбоку
                let position = {
                    top: emojiPickerMain.style.top = positions.buttonTop - positions.emojiHeight,
                    left: emojiPickerMain.style.left = positions.buttonFromLeft - positions.emojiWidth + 40,
                    bottom: emojiPickerMain.style.top = positions.buttonTop,
                    right: emojiPickerMain.style.left = positions.buttonFromLeft + positions.buttonWidth - 40
                }
